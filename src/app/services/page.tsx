            ...
            {[
              {
                ...
                title: '自然言語での要件定義',
                description:
                  '専門用語不要。やりたいことを日本語で伝えるだけで、AIがシステム設計に落とし込みます。',
              },
              {
                icon: Cpu,
                title: 'AIによるコード生成',
                description:
                  '人間が監督し、AIが実装。開発工数を大幅に削減しながら、高品質なコードを生成します。',
              },
              {
                icon: Zap,
                title: '迅速なプロトタイピング',
                description:
                  '動くものを素早く作成し、実際に触りながら改善。認識のズレを早期に解消します。',
              },
              {
                icon: Shield,
                title: '人間による品質保証',
                description:
                  'AIが生成したコードは、必ず人間がレビュー。セキュリティと品質を担保します。',
              },
            ].map((item, index) => (
              <motion.div
                key={item.title}
